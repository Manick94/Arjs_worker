...
function start2(container, marker, video, input_width, input_height, canvas_draw, render_update, track_update){
    ...
    //default sphere model to draw on NFT marker
    ...
    //Initializing the ARveo Model to draw on a nft marrker

    // initialize the GLTF Loader
    var threeGLTFLoader = new THREE.GLTFLoader();

    threeGLTFLoader.load("../Data/models/ARveo8.glb", 
    function (gltf) {
    ...
    var load = function(){
        ...
        canvas_process.style.clientHight = ph + "px";
